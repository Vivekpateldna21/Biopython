...
Objectives
To automate biological sequence analysis
To understand practical usage of BioPython
To perform sequence validation, analysis, ORF detection, and BLAST verification
To build a beginner-friendly bioinformatics tool
Project File Structure
Automated-Bioinfo-pipeline/
├── gsk1_seq_input.py 
├── gsk2_seq_analysis.py 
├── gsk3_orf_detection.py 
├── gsk4_check_blast.py 
├── gsk3A.fasta 
├── blast_result.xml
├──gsk_blast
